...
function Dashboardnotinstore() {
  ...
  useEffect(() => {
    ...
    let url =
      mode === "days"
        ? `http://localhost:3000/api/orders/stats/days?start=${start}&end=${end}/in-store`
        : `http://localhost:3000/api/orders/stats/months?start=${start}&end=${end}/in-store`;
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://localhost:3000/api/orders/stats/top-products-all?mode=${topMode}&start=${topStart}&end=${topEnd}/in-store`
      )
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `http://localhost:3000/api/orders/stats/product/${selectedProduct}/days?start=${prodStart}&end=${prodEnd}/in-store`
      )
      .then((res) => {
        setProdChartData({
