...
function Dashboardnotinstore() {
  ...
  useEffect(() => {
    ...
    let url =
      mode === "days"
        ? `https://khmiri-resto.onrender.com/api/orders/stats/days?start=${start}&end=${end}/in-store`
        : `https://khmiri-resto.onrender.com/api/orders/stats/months?start=${start}&end=${end}/in-store`;
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://khmiri-resto.onrender.com/api/orders/stats/top-products-all?mode=${topMode}&start=${topStart}&end=${topEnd}/in-store`
      )
      .then((res) => {
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://khmiri-resto.onrender.com/api/orders/stats/product/${selectedProduct}/days?start=${prodStart}&end=${prodEnd}/in-store`
      )
      .then((res) => {
        setProdChartData({
