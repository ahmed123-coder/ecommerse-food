...
function User() {
  ...
  const addUser = async (formdata) => {
    try {
      await axios.post("https://khmiri-resto.onrender.com/api/users/admin", formdata, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const handleDeleteUser = async (userId) => {
    try {
      await axios.delete(`https://khmiri-resto.onrender.com/api/users/${userId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
  ...
  const updateUser = async (userId) => {
    try {
      await axios.put(`https://khmiri-resto.onrender.com/api/users/${userId}`, formdata, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
