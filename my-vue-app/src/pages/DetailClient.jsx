...
function DetailClient() {
  ...
  const handlePostCart = async (e) => {
    ...
    try {
      ...
      const responseOrder = await axios.post("https://khmiri-resto.onrender.com/api/orders", orderData, {
      ...
      await axios.post("https://khmiri-resto.onrender.com/api/details", updatedFormData, {
        headers: { "Content-Type": "application/json" },
      });
